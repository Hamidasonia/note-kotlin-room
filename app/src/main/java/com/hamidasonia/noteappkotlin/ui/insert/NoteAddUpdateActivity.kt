...
import com.hamidasonia.noteappkotlin.R
import com.hamidasonia.noteappkotlin.database.Note
import com.hamidasonia.noteappkotlin.databinding.ActivityNoteAddUpdateBinding
import com.hamidasonia.noteappkotlin.helper.DateHelper
import com.hamidasonia.noteappkotlin.helper.ViewModelFactory
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    private lateinit var noteAddUpdateViewModel: NoteAddUpdateViewModl
    ...
    private fun obtainViewModel(activity: AppCompatActivity): NoteAddUpdateViewModl {
        val factory = ViewModelFactory.getInstance(activity.application)
        return ViewModelProvider(activity, factory).get(NoteAddUpdateViewModl::class.java)
    }
}